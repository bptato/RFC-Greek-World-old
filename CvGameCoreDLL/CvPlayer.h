...
public:
	...
	CvCity* getPreviousCapitalCity() const;																																// Exposed to Python
	...
	int getStartingTurn(); //Rhye RFGW
	DllExport int getSettlersMaps(int y, int x); //Rhye RFGW
