...
#import CvPediaCorporation #Rhye RFGW
...
class CvPediaMain( CvPediaScreen.CvPediaScreen ):
	...
	def __init__(self):
		...
		#self.pediaCorporation = CvPediaCorporation.CvPediaCorporation(self) #Rhye RFGW
		...
		self.mapCategories = { 
			...
			#CivilopediaPageTypes.CIVILOPEDIA_PAGE_CORPORATION	: self.placeCorporations, #Rhye RFGW
...
##					[18,17,"HINTS"],				
	...
	def setPediaCommonWidgets(self):
		...
		#self.szCategoryCorporation = localText.getText("TXT_KEY_CONCEPT_CORPORATIONS", ())	#Rhye RFGW
...
#		self.szCategoryUpgrades = localText.getText("TXT_KEY_PEDIA_CATEGORY_UPGRADES", ()) #Rhye
		...
		self.listCategories = [ self.szCategoryTech, 
					...
					self.szCategoryReligion, 
				        #self.szCategoryCorporation, #Rhye RFGW
	...
	def displayTopics(self, tList, widgeyType, buttonType):
		...
		iNumRows = 0
                ...
                if (widgeyType == WidgetTypes.WIDGET_PEDIA_JUMP_TO_UNIT):
                        tList.pop(83) #Hwacha
                        tList.pop(72) #Cataphract  
                        tList.pop(42) #Landsknecht
                        tList.pop(39) #Impi
                        tList.pop(34) #DogSoldier                          
                        tList.pop(33) #Vulture
                        tList.pop(29) #GallicWarrior
                        pass
