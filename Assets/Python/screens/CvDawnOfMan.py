...
##Rhye - begin
		...
		year = CyGameTextMgr().getDateStr(getTurnForYear(pActivePlayer.getStartingYear()), False, 0, -4400, 0)
...
##Rhye - end
	...
	def update(self, fDelta):
		##Rhye - begin
		if (getTurnForYear(gc.getPlayer(CyGame().getActivePlayer()).getStartingYear()) == 0):
			...
			iNumAutoPlayTurns = getTurnForYear(gc.getPlayer(CyGame().getActivePlayer()).getStartingYear())
			iNumTurnsRemaining = max(0, iNumAutoPlayTurns - iGameTurn)  #RFCRAND (temporary fix)
