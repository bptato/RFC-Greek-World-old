...
#import CvCorporationScreen #Rhye RFGW
...
def getRazeOnly(argsList):
        return con.tRazeOnly[argsList[0]]
def getFeedUnits(argsList):
        return con.getFeedUnits(argsList[0])
def getRefusePeaceAI(argsList):
        return con.tRefusePeaceAI[argsList[0]]
...
def getCompactEmpireModifier(argsList):
        return con.tCompactEmpireModifier[argsList[0]]
...
HandleInputMap = {  MAIN_INTERFACE : mainInterface,
					...
					#CORPORATION_SCREEN : corporationScreen, #Rhye RFGW
					...
					#PEDIA_CORPORATION : pediaMainScreen, #Rhye RFGW
